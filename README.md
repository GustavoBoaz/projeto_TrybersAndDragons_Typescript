...
- [Requisitos do projeto](#requisitos-do-projeto)
  - [Requisitos Obrigatórios](#requisitos-obrigatórios)
    ...
    - [6 - Crie a interface `Fighter`](#6---criar-a-interface-fighter)
    - [7 - Crie a classe `Character`](#7---crie-a-classe-character)
    - [8 - Crie a interface `SimpleFighter`](#8---criar-a-interface-simplefighter)
    - [9 - Crie a classe `Monster`](#9---criar-a-classe-monster)
    - [10 - Crie a classe `PVP`](#10---criar-a-classe-pvp)
  - [Requisitos Bônus](#requisitos-bônus)
    - [11 - Crie a classe `PVE`](#11---criar-a-classe-pve)
    - [12 - Crie a classe `Dragon`](#12---criar-a-classe-dragon)
    - [13 - Crie objetos no arquivo `index`](#13---criar-objetos-no-arquivo-index)
...
Energia é um atributo vital para a maioria dos seres. A energia gasta ao andar, nadar, escalar ou lutar é chamada de _stamina_ no contexto de `Trybers and Dragons`. Contudo, este universo também abriga seres capazes de usar magia. Nesses casos, a energia gasta ao utilizar magias é chamada de _'mana'_.
