...
- [Requisitos do projeto](#requisitos-do-projeto)
  - [Requisitos Obrigatórios](#requisitos-obrigatórios)
    ...
    - [6 - Criar a interface `Fighter`](#6---criar-a-interface-fighter)
    - [7 - Crie a classe `Character`](#7---crie-a-classe-character)
    - [8 - Criar a interface `SimpleFighter`](#8---criar-a-interface-simplefighter)
    - [9 - Criar a classe `Monster`](#9---criar-a-classe-monster)
    - [10 - Criar a classe `PVP`](#10---criar-a-classe-pvp)
