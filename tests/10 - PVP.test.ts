describe('10 - Classe PVP', () => {
  ...
  it('A classe PVP pode ser utilizada onde a classe Battle é esperadae um personagem que chamou várias vezes o levelUp e possue melhores atributos tem maiores chances de vencer', () => {
