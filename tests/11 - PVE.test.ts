describe('11 - Classe PVE', () => {
  ...
  it('- A classe PVE pode ser utilizada onde a classe Battle é esperada, e um personagem (Character) que chamou várias vezes o levelUp e possue melhores atributos tem maiores chances de vencer uma luta contra somente um Monster e um personagem com atributos menores perde uma luta contra diversos Monsters;', () => {
